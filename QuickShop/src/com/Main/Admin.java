...
public class Admin {
	...
	//method for login
	/*suggestion-in company, we dont design method directly into class,
	first define method in interface then implement 
    in the class*/
	public void adminLogin() {
		...
		if(isAdmin) {
			...
			//nice use of switch case high level
			switch(choice) {
			case 1:
				adminLogin();
				break;
